from app.ai.impl.tongyi_ai import TongyiComponent
...
elif Config.AI_SERVER=='TONGYI':
    chat_ai = TongyiComponent(api_key=Config.TONGYI_AI_API_KEY, model=Config.TONGYI_AI_MODEL)
else:
